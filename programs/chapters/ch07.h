...
void mixer(float f_t, float tau_phi, float tau_theta, float tau_psi) {
  omega_1 = f_t / (4 * Kl) - tau_phi / (4 * Kl * l) - tau_theta / (4 * Kl * l) -
            tau_psi / (4 * Kl * l);
  omega_2 = f_t / (4 * Kl) - tau_phi / (4 * Kl * l) + tau_theta / (4 * Kl * l) +
            tau_psi / (4 * Kd);
  omega_3 = f_t / (4 * Kl) + tau_phi / (4 * Kl * l) + tau_theta / (4 * Kl * l) +
            tau_psi / (4 * Kd);
  omega_4 = f_t / (4 * Kl) + tau_phi / (4 * Kl * l) - tau_theta / (4 * Kl * l) +
            tau_psi / (4 * Kd);
}
